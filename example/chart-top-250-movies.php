...
if (isset($_GET["output"])) {
    ...
    echo json_encode($chart->getTop250Movies());
    exit();
}
?>
<!DOCTYPE html>
...
<a href="/example/chart-top-250-movies.php?output=json" class="output-json-link">JSON Format</a>

<div class="container">
    <div class="boxed">
        <!-- Title -->
        <h2 class="text-center pb-30">Top 250 Movies</h2>
        ...
        <div class="flex-container">
            <table class="table">
                ...
                <?php foreach ($chart->getTop250Movies() as $row) { ?>
                <tr>
